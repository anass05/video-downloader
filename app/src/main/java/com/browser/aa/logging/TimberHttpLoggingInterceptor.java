package com.browser.aa.logging;
...
public class TimberHttpLoggingInterceptor implements Interceptor {
     ...
     */
    public TimberHttpLoggingInterceptor setLevel(Level level) {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (logHeaders) {
            if (hasRequestBody) {
                ...
                if (requestBody.contentType() != null) {
                    Timber.i("Content-Type: " + requestBody.contentType());
                }
            ...
            if (!logBody || !hasRequestBody) {
                ...
                if (isPlaintext(buffer)) {
                    ...
                    Timber.i("--> END " + request.method() + " (binary "
        ...
        try {
            ...
            Timber.i("<-- HTTP FAILED: " + e.getMessage());
            throw e;
        }
        ...
        Timber.i("<-- " + response.code() + ' ' + response.message() + ' '
            ...
            if (!logBody || !hasBody(response)) {
                ...
                if (contentType != null) {
                    try {
                        ...
                        Timber.i("Couldn't decode the response body; charset is likely malformed.", e);
                        Timber.i("<-- END HTTP");
